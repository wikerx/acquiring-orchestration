 ...
 * @email : scott_x@163.com
 * @description : 商户 OpenAPIOpen Api Payment V2 管理接口，位于 service-openapi 的接口层，用于承载该模块对应的业务职责和数据流转边界。
 * @status : create
 */
...
public class OpenApiPaymentV2Controller {
     ...
     */
    public OpenApiPaymentV2Controller(OpenApiPaymentApplicationService paymentApplicationService) {
