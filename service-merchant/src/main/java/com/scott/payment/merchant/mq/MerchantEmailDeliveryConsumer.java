...
public class MerchantEmailDeliveryConsumer implements RocketMQListener<String> {
    ...
    public void onMessage(String payload) {
        ...
        if (message == null) {
            log.warn("event: MERCHANT_EMAIL_DELIVERY_INVALID payloadLength: {}", payload == null ? 0 : payload.length());
            return;
        }
    ...
    private EmailDeliveryMessage parse(String payload) {
        ...
        try {
            ...
            log.warn("event: MERCHANT_EMAIL_DELIVERY_DESERIALIZE_FAILED payloadLength: {} exceptionType: {}",
