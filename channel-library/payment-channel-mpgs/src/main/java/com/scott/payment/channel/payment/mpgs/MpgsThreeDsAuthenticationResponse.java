 ...
 * @author : scott
 * @version : v1.0.0
 * @classname : MpgsThreeDsAuthenticationResponse
 * @date : 2026-09-02 08:03
 * @email : scott_x@163.com
 * @description : MPGS 3DS Direct API 认证响应摘要。
 * @status : create
 */
@Data
public class MpgsThreeDsAuthenticationResponse implements Serializable {
    ...
    /**
     * Initiate 阶段的 3DS Method 或 Authenticate 阶段的 ACS Challenge HTML；只允许返回受控收银台，日志保存摘要。
     */
    private String redirectHtml;

    /**
     * 3DS Method 或 ACS Challenge 跳转地址。
     */
