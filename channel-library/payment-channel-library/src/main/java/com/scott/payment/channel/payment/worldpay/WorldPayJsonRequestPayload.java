...
public class WorldPayJsonRequestPayload {
     ...
     * @date : 2026-07-26 00:00
     * @email : scott_x@163.com
     * @description : Worldpay JSON merchant 节点对象，位于 payment-channel-library 渠道协议模型层，封装商户在 Worldpay 的 entity 编码；输入来自后台 MID 配置，输出到 Access Worldpay JSON 请求体。
     * @status : create
     */
    @Data
     ...
     * @date : 2026-07-26 00:00
     * @email : scott_x@163.com
     * @description : Worldpay JSON instruction 节点对象，位于 payment-channel-library 渠道协议模型层，封装卡交易方法、自动请款、认证结果、账单描述、金额和支付工具；不负责 HTTP 调用或平台状态推进。
     * @status : create
     */
    @Data
     ...
     * @date : 2026-07-26 00:00
     * @email : scott_x@163.com
     * @description : Worldpay JSON requestAutoSettlement 节点对象，位于 payment-channel-library 渠道协议模型层，封装是否请求渠道授权后自动请款；输入来自交易类型和 MID 元数据。
     * @status : create
     */
    @Data
     ...
     * @date : 2026-07-26 00:00
     * @email : scott_x@163.com
     * @description : Worldpay JSON narrative 节点对象，位于 payment-channel-library 渠道协议模型层，封装持卡人账单或渠道后台可见的商户描述；不允许承载卡号、密钥或个人敏感值。
     * @status : create
     */
    @Data
     ...
     * @date : 2026-07-26 00:00
     * @email : scott_x@163.com
     * @description : Worldpay JSON value 节点对象，位于 payment-channel-library 渠道协议模型层，封装最小辅币单位金额和 ISO 币种；输入来自平台主币种金额按辅币位转换后的结果。
     * @status : create
     */
    @Data
     ...
     * @date : 2026-07-26 00:00
     * @email : scott_x@163.com
     * @description : Worldpay JSON paymentInstrument 节点对象，位于 payment-channel-library 渠道协议模型层，封装明文卡号、有效期、CVC、卡品牌、持卡人姓名和账单地址；PAN/CVC 只允许当前渠道请求内短暂使用。
     * @status : create
     */
    @Data
     ...
     * @date : 2026-07-26 00:00
     * @email : scott_x@163.com
     * @description : Worldpay JSON expiryDate 节点对象，位于 payment-channel-library 渠道协议模型层，封装卡有效期月份和年份；输入来自商户请求解密后的卡信息。
     * @status : create
     */
    @Data
     ...
     * @date : 2026-07-26 00:00
     * @email : scott_x@163.com
     * @description : Worldpay JSON billingAddress 节点对象，位于 payment-channel-library 渠道协议模型层，封装持卡人账单街道、邮编、城市、州省和国家地区代码；字段属于个人信息，日志必须脱敏。
     * @status : create
     */
    @Data
     ...
     * @date : 2026-07-26 00:00
     * @email : scott_x@163.com
     * @description : Worldpay JSON authentication 节点对象，位于 payment-channel-library 渠道协议模型层，封装商户或收银台完成的 3DS 认证结果；用于提交给渠道判断责任转移和风险。
     * @status : create
     */
    @Data
     ...
     * @date : 2026-07-26 00:00
     * @email : scott_x@163.com
     * @description : Worldpay JSON threeDS 节点对象，位于 payment-channel-library 渠道协议模型层，封装 3DS 版本、ECI、认证值和 DS 交易号；authenticationValue 属于敏感认证数据。
     * @status : create
     */
    @Data
