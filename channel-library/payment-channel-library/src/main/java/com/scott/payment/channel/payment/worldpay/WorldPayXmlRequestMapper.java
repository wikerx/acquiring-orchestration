 ...
 * @description : WorldPay XML 请求映射器，位于 payment-channel-library 渠道协议层，负责把平台统一渠道请求映射为 WPGXML 请求对象，并委托 XML 编码器生成 paymentService 报文；输入包含交易类型、金额币种、卡数据和 MID 扩展，输出为可发送到 Worldpay XML Direct 的请求 XML。
 * @status : create
 */
@Component
