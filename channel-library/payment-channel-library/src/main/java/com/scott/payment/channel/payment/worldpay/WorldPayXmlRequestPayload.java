 ...
 * @description : WorldPay XML 请求对象模型，位于 payment-channel-library 渠道协议层，用于封装 WPG Direct XML 的 paymentService、submit、modify 和 inquiry 节点；输入来自平台统一渠道请求，输出交由 XML 编码器序列化，不直接执行 HTTP 调用。
 * @status : create
 */
@Data
