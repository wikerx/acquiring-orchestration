...
CREATE TABLE `sys_job_task` (
  ...
  `next_trigger_time` DATETIME(3) DEFAULT NULL COMMENT '下次触发时间',
  `last_trigger_time` DATETIME(3) DEFAULT NULL COMMENT '上次触发时间',
  `last_run_status` VARCHAR(30) DEFAULT NULL COMMENT '上次执行状态',
  `lock_owner` VARCHAR(100) DEFAULT NULL COMMENT '锁持有节点',
  `lock_until` DATETIME(3) DEFAULT NULL COMMENT '锁过期时间',
