 ...
 */
@Data
public class RefundPreparationResultDTO implements Serializable {
    ...
    /**
     * 完成 duplicate 的本地校验、字段转换或结果组装，供当前调用链继续使用。
     * <p>
     * 层级边界：支付核心服务层；输入来源、输出结构和异常语义由 RefundPreparationResultDTO 的方法签名及调用链约束。
