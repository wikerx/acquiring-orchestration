...
public interface MerchantFeeVersionSnapshotMapper {
    ...
    @Select("""
            SELECT fp.merchant_id AS merchant_id,
                   ...
                   fpv.initial_delay_unit AS initial_delay_unit,
                   fpv.initial_delay_days AS initial_delay_days,
                   fpv.regular_delay_days AS regular_delay_days,
                   fpv.settlement_frequency AS settlement_frequency,
                   fpv.frequency_day AS frequency_day,
                   fpv.effective_time AS effective_time,
