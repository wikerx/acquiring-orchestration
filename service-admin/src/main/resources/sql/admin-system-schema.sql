...
CREATE TABLE IF NOT EXISTS channel_payment_capability (
    ...
    transaction_type VARCHAR(512) NOT NULL DEFAULT 'NONE' COMMENT '交易类型列表，多个以英文逗号分隔；收单使用transaction_type，代付使用payout_transaction_type，NONE仅兼容历史数据',
...
(42, '代付交易类型', 'payout_transaction_type', 'channel', 1, 1, 1, 0);
...
(3007, 'acquiring_payment_method', '统一支付接口', 'UPI', 'zh-CN', 8, 'primary', NULL, 0, 1, 0),
(3008, 'acquiring_payment_method', 'Bitcoin', 'BTC_ON_CHAIN', 'zh-CN', 9, 'primary', '{"logoKey":"bitcoin","logoKeys":["bitcoin"]}', 0, 1, 0),
(3009, 'acquiring_payment_method', 'PYUSD', 'PYUSD', 'zh-CN', 10, 'primary', NULL, 0, 1, 0),
...
(3103, 'payout_payment_method', '银行卡', 'BANK_CARD', 'zh-CN', 4, 'primary', '{"logoKey":"bankCard","logoKeys":["visa","mastercard","jcb","maestro"]}', 0, 1, 0),
(3104, 'payout_payment_method', 'Google Pay', 'GOOGLE_PAY', 'zh-CN', 5, 'primary', '{"logoKey":"googlePay","logoKeys":["googlePay"]}', 0, 1, 0),
(3105, 'payout_payment_method', 'ACH Debit', 'ACH_DEBIT', 'zh-CN', 6, 'primary', '{"logoKey":"achDebit","logoKeys":["achDebit"]}', 0, 1, 0),
(3106, 'payout_payment_method', '统一支付接口', 'UPI', 'zh-CN', 7, 'primary', NULL, 0, 1, 0),
(3107, 'payout_payment_method', 'Venmo', 'VENMO', 'zh-CN', 8, 'primary', NULL, 0, 1, 0),
(3108, 'payout_payment_method', 'Bitcoin', 'BTC_ON_CHAIN', 'zh-CN', 9, 'primary', '{"logoKey":"bitcoin","logoKeys":["bitcoin"]}', 0, 1, 0),
(3109, 'payout_payment_method', 'PYUSD', 'PYUSD', 'zh-CN', 10, 'primary', NULL, 0, 1, 0),
...
(4200, 'payout_transaction_type', '代付', 'PAYOUT', 'zh-CN', 1, 'primary', NULL, 1, 1, 0),
(4201, 'payout_transaction_type', '取消', 'CANCEL', 'zh-CN', 2, 'warning', NULL, 0, 1, 0),
...
(13007, 'acquiring_payment_method', 'UPI', 'UPI', 'en-US', 8, 'primary', NULL, 0, 1, 0),
(13008, 'acquiring_payment_method', 'Bitcoin', 'BTC_ON_CHAIN', 'en-US', 9, 'primary', '{"logoKey":"bitcoin","logoKeys":["bitcoin"]}', 0, 1, 0),
(13009, 'acquiring_payment_method', 'PYUSD', 'PYUSD', 'en-US', 10, 'primary', NULL, 0, 1, 0),
...
(13103, 'payout_payment_method', 'Bank Card', 'BANK_CARD', 'en-US', 4, 'primary', '{"logoKey":"bankCard","logoKeys":["visa","mastercard","jcb","maestro"]}', 0, 1, 0),
(13104, 'payout_payment_method', 'Google Pay', 'GOOGLE_PAY', 'en-US', 5, 'primary', '{"logoKey":"googlePay","logoKeys":["googlePay"]}', 0, 1, 0),
(13105, 'payout_payment_method', 'ACH Debit', 'ACH_DEBIT', 'en-US', 6, 'primary', '{"logoKey":"achDebit","logoKeys":["achDebit"]}', 0, 1, 0),
(13106, 'payout_payment_method', 'UPI', 'UPI', 'en-US', 7, 'primary', NULL, 0, 1, 0),
(13107, 'payout_payment_method', 'Venmo', 'VENMO', 'en-US', 8, 'primary', NULL, 0, 1, 0),
(13108, 'payout_payment_method', 'Bitcoin', 'BTC_ON_CHAIN', 'en-US', 9, 'primary', '{"logoKey":"bitcoin","logoKeys":["bitcoin"]}', 0, 1, 0),
(13109, 'payout_payment_method', 'PYUSD', 'PYUSD', 'en-US', 10, 'primary', NULL, 0, 1, 0),
...
(14200, 'payout_transaction_type', 'Payout', 'PAYOUT', 'en-US', 1, 'primary', NULL, 1, 1, 0),
(14201, 'payout_transaction_type', 'Cancel', 'CANCEL', 'en-US', 2, 'warning', NULL, 0, 1, 0),
