...
public class AdminRiskWhiteController {
    ...
    /**
     * MODULE TYPE，用于区分 Admin Risk White Controller 记录的处理类别、配置维度或外部协议枚举。
     * <p>
    ...
    /**
     * risk Management Application Service 依赖，用于 Admin Risk White Controller 调用对应的数据访问、远程调用或领域服务能力。
     * <p>
