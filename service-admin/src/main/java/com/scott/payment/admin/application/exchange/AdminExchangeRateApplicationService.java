 ...
 * @description : admin汇率汇率应用服务，位于 运营后台服务，编排可信登录上下文、权限、领域服务调用和响应模型组装。
 * @status : create
 */
@Service
public class AdminExchangeRateApplicationService {
    ...
    /**
     * {@code EXPORT_TIME_FORMATTER}常量，统一 {@code AdminExchangeRateApplicationService} 内部使用的配置值、状态码或协议字段。
     * <p>
