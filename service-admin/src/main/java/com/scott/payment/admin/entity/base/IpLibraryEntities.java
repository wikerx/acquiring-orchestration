 ...
 * @description : IP Library Entities 聚合类型，位于 运营后台服务，集中定义同一业务域下的请求、响应、查询条件和持久化视图模型。
 * @status : create
 */
public final class IpLibraryEntities {
    ...
    public static class IpLibrarySplitModelDO {
        /**
         * {@code IpLibrarySplitModelDO} 数据库主键，用于唯一标识当前记录。
         * <p>
        ...
        private Long id;
        /**
         * {@code ipType}，用于区分 {@code IpLibrarySplitModelDO} 记录的处理类别、配置维度或外部协议枚举。
         * <p>
        ...
        /**
         * 持久化的{@code shardNo}，用于还原当前记录的业务事实。
         * <p>
         * 单位：无；格式：业务编号字符串；是否允许为空由接口校验、数据库约束或调用契约决定；非敏感字段。
         * 取值范围：长度、唯一性和可空性由接口校验或数据库唯一约束限制；数据来源：数据库表记录或持久化写入对象。
         * </p>
        ...
        /**
         * 持久化的{@code activeFlag}，用于还原当前记录的业务事实。
         * <p>
        ...
        /**
         * {@code loadStatus}，表示当前记录在业务流程中的处理状态。
         * <p>
    ...
    public static class IpLibraryDataRow {
        /**
         * {@code IpLibraryDataRow} 数据库主键，用于唯一标识当前记录。
         * <p>
         * 单位：无；格式：业务编号字符串；是否允许为空由接口校验、数据库约束或调用契约决定；非敏感字段。
         * 取值范围：长度、唯一性和可空性由接口校验或数据库唯一约束限制；数据来源：数据库表记录或持久化写入对象。
         * </p>
        ...
        private Long id;
        /**
         * {@code ipType}，用于区分 {@code IpLibraryDataRow} 记录的处理类别、配置维度或外部协议枚举。
         * <p>
         * 单位：无；格式：枚举编码或受控字符串；是否允许为空由接口校验、数据库约束或调用契约决定；可识别字段，日志输出必须脱敏或截断。
         * 取值范围：取值必须来自对应枚举、字典或渠道协议；数据来源：数据库表记录或持久化写入对象。
         * </p>
        ...
        private String ipType;
        /**
         * {@code ipNumberStart}字段，保存 {@code IpLibraryDataRow} 当前处理所需的业务取值。
         * <p>
        ...
        /**
         * {@code ipNumberEnd}字段，保存 {@code IpLibraryDataRow} 当前处理所需的业务取值。
         * <p>
         * 单位：无；格式：字符串、对象引用或集合结构；是否允许为空由接口校验、数据库约束或调用契约决定；可识别字段，日志输出必须脱敏或截断。
         * 取值范围：取值范围受数据库字段长度、Bean Validation、接口协议或配置枚举约束；数据来源：数据库表记录或持久化写入对象。
         * </p>
        ...
        /**
         * {@code stateProvince}字段，保存 {@code IpLibraryDataRow} 当前处理所需的业务取值。
         * <p>
         * 单位：无；格式：字符串、对象引用或集合结构；是否允许为空由接口校验、数据库约束或调用契约决定；非敏感字段。
         * 取值范围：取值范围受数据库字段长度、Bean Validation、接口协议或配置枚举约束；数据来源：数据库表记录或持久化写入对象。
         * </p>
